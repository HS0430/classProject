...
public class SmartPhone2 {
	...
	SmartPhone2(int size){
		contacts = new Contact2[size];
		numOfContact = 0;
		sc = new Scanner(System.in);
	}
	
	private static SmartPhone2 sp = new SmartPhone2(10);
	
	public static SmartPhone2 getInstance() {
		
		if(sp == null) {
			sp = new SmartPhone2(10);
		}
	...
	void insertContact() {
		...
		// 2. 인스턴스 생성
		Contact2 contact = new Contact2(name, phoneNumber, email, address, birthday, group);
	...
	void editContact() {
		...
		Contact2 contact = contacts[searchIndex];
