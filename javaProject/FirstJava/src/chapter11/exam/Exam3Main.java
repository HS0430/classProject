...
//		같은 이름의 선수는 번호 순으로 저장하는 프로그램을 만들어 봅시다. 
		...
		players.add(new FootballPlayer("손흥민", 7, "토트넘", 20));
		players.add(new FootballPlayer("루니", 9, "맨유", 33));
		players.add(new FootballPlayer("루니5", 113, "맨유", 20));
		players.add(new FootballPlayer("손흥민", 77, "토트넘", 30));
		players.add(new FootballPlayer("케인77", 1, "토트넘", 25));
		players.add(new FootballPlayer("이강인99", 5, "토트넘", 19));
