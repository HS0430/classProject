        ...
        <table class="table table-striped" >
            ...
            <c:forEach items="${deptList}" var="dept">
                <tr>
                    ...
                    <td>${dept.dname}</td>
                    <td>${dept.loc}</td>
                    <td><a href="/dept/edit?deptno=${dept.deptno}" style="text-decoration: none" class="btn btn-info">수정</a> / <a onclick="deleteDept(${dept.deptno});" style="cursor: pointer" class="btn btn-info">삭제</a></td>
                </tr>
            </c:forEach>
        </table>
    <small class="d-block text-right mt-3">
        <a class="btn btn-success" href="/dept/register">부서 등록</a>
